...
export const SSL_PRIV_KEY_PATH = "/doclin-api/letsencrypt/api.doclin.dev/live/privkey.pem";
export const SSL_CERT_PATH = "/doclin-api/letsencrypt/api.doclin.dev/live/fullchain.pem";
